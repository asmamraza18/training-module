      ...
      <Card>
        ...
        <CardContent>
          {!showResults ? (
            <>
              ...
              <RadioGroup value={selectedAnswers[currentQuestion].toString()} onValueChange={(value) => handleAnswerSelection(parseInt(value))}>
        ...
        <CardFooter className="flex justify-between">
          {!showResults ? (
            ...
            <Button onClick={resetQuiz} className="w-full">Retake Quiz</Button>
          )}
        </CardFooter>
      </Card>
    </div>
